class Student(object):
    ...
    def delete_student(self, student_num):
        if not self.is_student_existed(student_num):
            return '该学号不存在'
        with open('student.txt', 'r') as file:
            lines = file.readlines()
    ...
    def is_student_existed(self, student_num):
        with open('student.txt', 'r') as file:
            lines = file.readlines()
            for line in lines:
                if student_num == line[0:5]:
    ...
    while True:
        try:
            ...
            if number == 1:
                ...
                student_num = input('请输入需要查询的学生学号：')
                ...
                student_num = input('请输入需要删除的学生学号：')
                ...
                student_num = input('请输入需要修改的学生学号：')
